...
?>
				<h2>予定を削除　確認画面</h2>
				<div id="center">
					<p>下記の予定を削除する場合は、予定を削除ボタンをクリックしてください。<br>
						参加予定者がいる場合、呼びかけ人の方は、予定をキャンセルしたことを参加予定者に伝えるようにしてください。<br>
						削除した予定を復活させたい場合や、操作ミスで削除してしまった場合は<?=$syusaisya?>まで連絡ください。
					</p>
					<table id="add">
						<tr>
...
?>
					...
					<div class="submitDel2">
						<form id="btnDel" method="post" action="del3.php">
							<input type="hidden" name="id" value="<?=$id?>" />
							<input type="submit" id="btnDel" name="btnDel" value="予定を削除" />
						</form>
