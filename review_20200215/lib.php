...
_EOT_;
    ...
    function html_header() {
        ...
        print "<h1>" . $appli_name . "</h1>";
        print "<a href=\"$fileLOGOUT\">ログアウト</a>";
print <<<_EOT_
        <img src = "./img/3d218719-s.png" alt = "3d218719-s" height = "100" border = "0" hspace = "20">    
        <img src = "./img/kurumaisu_man.png" alt = "kurumaisu_man.png" height = "100" border = "0" hspace = "20">
        <img src = "./img/sunaba_kodomo.png" alt = "sunaba_kodomo" height = "100" border = "0">
...
_EOT_;
    ...
    function html_yotei(){
        ...
        <table border=1>
            ...
            foreach ($asobi_data as $value) {
                ...
                print "<td>" . htmlspecialchars($value['sankasya'], ENT_QUOTES, 'UTF-8') . "</td>";
                print "</tr>";
            }
        print "</table>";
    }
    ...
    function html_cancel(){
        ...
        if ($link) {
            ...
            // 参加予定者を配列にする
            //<br> を<br>に置換
            $list_query2 = 'SELECT sankasya FROM minaso_yotei where flag <> 3 ORDER BY date1 ASC';
            // クエリを実行
            $list_result2 = mysqli_query($link,$list_query2);
            // 1行ずつ結果を配列で取得
            while($row2 = mysqli_fetch_array($list_result2)){
                $sankasya = $row2;
            }
